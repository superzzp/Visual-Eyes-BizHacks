...
In addition, a client website demo serves as an data visualization tool. It is built with React and JavaScript and reads data from the Firebase server and converts it into beautiful graphs built with Plotly. It can display accumulated user emotions as a pie chart.
